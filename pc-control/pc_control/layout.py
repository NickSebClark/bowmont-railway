...
class Layout(pygame.Surface):
    ...
    def __init__(self):
        ...
        sw10 = CrossOver(self, 140, 280, name="SW10")
        ...
        sw6 = CrossOver(self, 240, 160, name="SW6")
        ...
        tr8 = Track(self, sw4_diverge, sw9_diverge)
        ...
        tr14 = Track(self, sw6_exit1, (sw5_enter[0] + 70, sw5_enter[1] + 15), [(sw5_enter[0] + 40, sw6_exit1[1])])
        tr15 = Track(self, sw3_diverge, (sw5_enter[0] + 85, sw5_enter[1] - 15), [(sw3_diverge[0] - 20, sw3_diverge[1])])
    ...
    def draw(self, mouse_pos: Tuple[int, int], mouse_up: bool):
        ...
        pygame.draw.lines(self, (255, 255, 255), False, [(342, 0), (342, 135), (120, 135), (120, Layout.height)])
